...
class _HomeContentState extends State<HomeContent>
  ...
  void generateNewCircle() {
    bodys.add(Body(generateRandomNumber(), generateRandomNumber(), 0.000000005,
        -0.0000000005, Random().nextDouble() / 2));
  }
}
...
class Body {
  ...
  Body(double positionX, double positionY, double velocityX, double velocityY,
      double mass) {
    ...
    this.mass = mass;
    if (this.mass != 3.0) {
      this.radius = ((3 * (this.mass / (pi * 4))) / 3) * 500;
    } else {
      this.radius = 10.0;
    }
  }
